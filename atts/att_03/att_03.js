...
utils.linkUniformMatrix({
    shaderName: "uProjectionMatrixPersp",
    value: projectionPerspMatrix,
    kind: "4fv"
})
...
let viewMatrixCam1 = mat4.create()
mat4.lookAt(
    viewMatrixCam1,
    [5, 5, 5], // Camera Pos
    [0, 0, 0], // Camera Olhando
    [0, 1, 0] // Up, camera na vertical
)

let viewMatrixCam2 = mat4.create()
mat4.lookAt(
    viewMatrixCam2,
    [15, 15, 15], // Camera Pos
    [0, 0, 0], // Camera Olhando
...
let viewMatrixCam3 = mat4.create()
mat4.lookAt(
    viewMatrixCam3,
    [2, 2, 2], // Camera Pos
    [0, 0, 0], // Camera Olhando
...
function render() {
    ...
    utils.linkUniformMatrix({ shaderName: "uViewMatrix", value: viewMatrixCam1, kind: "4fv" });
    utils.drawScene({ method: "TRIANGLES", viewport: { x: 0, y: 0, width: sceneSize, height: sceneSize } });

    utils.linkUniformMatrix({ shaderName: "uViewMatrix", value: viewMatrixCam2, kind: "4fv" });
    utils.drawScene({ method: "TRIANGLES", viewport: { x: sceneSize, y: 0, width: sceneSize, height: sceneSize } });

    utils.linkUniformMatrix({ shaderName: "uViewMatrix", value: viewMatrixCam3, kind: "4fv" });
