...
var mouseMove, mouseDown, isDown = false;
...
canvas.addEventListener("mousemove", (ev) => {
  if (isDown) {
    ...
    render(...convertCoord(mouseDown.x, mouseDown.y), ...convertCoord(mouseMove.x, mouseMove.y), ...convertCoord(mouseMove.x, mouseDown.y))
  }
